...
```bash
curl -X POST https://thriving-presence-production-ca4a.up.railway.app/analyze \
...
```bash
curl -s https://thriving-presence-production-ca4a.up.railway.app/status/TEST-KEY-001 | python3 -m json.tool
```
